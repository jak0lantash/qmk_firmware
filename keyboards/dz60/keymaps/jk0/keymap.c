...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[LAYER_QWERTY] = LAYOUT_JK0(
		...
		KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, FN, KC_ENT, KC_RALT, KC_LEFT, KC_DOWN, KC_RIGHT
	),
	...
	[LAYER_FN] = LAYOUT_JK0(
		M_GRAVE, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_DEL, RESET,
